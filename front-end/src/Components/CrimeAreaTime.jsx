...
function CrimeAreaTimeQuery() {
  ...
  return (
      <div>
        ...
        <p>
          This graph allows users to select an area of Los Angeles and the year. The trends that are shown with these graphs
          shows that in each area and each year, the amount of crimes that occur is generally the same. Despite the lack of a
          clear graphical trend, users of our app should recognize this as a reason to stay vigilant at any time of the year.
          A trend that could be gotten from these graphs, is the fact that the areas of Foothill, Mission, and West LA
          typically have lower numbers of crime whereas Central and 77th Street have the highest number of crimes throughout the years.
        </p>
      </div>
  );
}
